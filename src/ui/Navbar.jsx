...
function Navbar({ open, onClose, children }) {
  ...
  return (
    <div
      ...
      <div
        className={`backdrop-blur-sm fixed top-0 left-0 right-0 bottom-0 w-4/6 h-screen bg-secondery-800 bg-opacity-30 z-50 navbar
  ${open ? "open" : ""}`}>
        <div
          ref={modalRef}
          className="bg-white h-screen w-full max-w-sm min-w-screen">
